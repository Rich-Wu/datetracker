...
type Date struct {
	...
	Cost       float32            `json:"cost,omitempty" bson:"cost,omitempty" form:"cost" binding:"required"`
	Result     string             `json:"result,omitempty" bson:"result,omitempty" form:"result" binding:"required"`
