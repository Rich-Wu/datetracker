...
chart_js__WEBPACK_IMPORTED_MODULE_1__.Chart.register(chartjs_plugin_datalabels__WEBPACK_IMPORTED_MODULE_0__["default"], chart_js__WEBPACK_IMPORTED_MODULE_1__.BarController, chart_js__WEBPACK_IMPORTED_MODULE_1__.PieController, chart_js__WEBPACK_IMPORTED_MODULE_1__.CategoryScale, chart_js__WEBPACK_IMPORTED_MODULE_1__.LinearScale, chart_js__WEBPACK_IMPORTED_MODULE_1__.BarElement, chart_js__WEBPACK_IMPORTED_MODULE_1__.LineController, chart_js__WEBPACK_IMPORTED_MODULE_1__.PointElement, chart_js__WEBPACK_IMPORTED_MODULE_1__.LineElement, chart_js__WEBPACK_IMPORTED_MODULE_1__.ArcElement, chart_js__WEBPACK_IMPORTED_MODULE_1__.Colors, chart_js__WEBPACK_IMPORTED_MODULE_1__.Title, chart_js__WEBPACK_IMPORTED_MODULE_1__.Tooltip);
chart_js__WEBPACK_IMPORTED_MODULE_1__.Chart.defaults.set('plugins.datalabels', {
    anchor: 'end',
    align: 'top'
});
const tooltipDollar = (tooltipItem) => {
...
const getPrevMonths = (numberOfMonths = 12, startingDate = new Date()) => {
    let out = [];
...
const renderChart = async function (el, cfg) {
    return new chart_js__WEBPACK_IMPORTED_MODULE_1__.Chart(el, cfg);
};
...
const aggDatesByMonth = (dates, months) => {
    const buckets = Array(months.length).fill(0);
    for (let i = 0; i < months.length; i++) {
        const [month, year] = months[i];
        buckets[i] = dates.filter((dateData) => {
            const occurrence = new Date(dateData.date);
...
const aggCostByMonth = (dates, months) => {
    const buckets = Array(months.length).fill(0);
    for (let i = 0; i < months.length; i++) {
        const [month, year] = months[i];
        buckets[i] = dates
...
const avgCostPerDateByMonth = (dates, months) => {
    const buckets = Array(months.length).fill(0);
    for (let i = 0; i < months.length; i++) {
        const [month, year] = months[i];
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _exports_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./exports.ts */ "./src/exports.ts");
/* harmony import */ var _scripts_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scripts.ts */ "./src/scripts.ts");
/* harmony import */ var _scripts_ts__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_scripts_ts__WEBPACK_IMPORTED_MODULE_1__);
